...
<div className='contenedorTarea'>
          ...
          <div className='tareas'>
            <div className='tarea'><input type="checkbox" /> Tarea</div>            
            <div className='descripcion'>Descripción Descripción Descripción Descripción Descripción Descripción</div>
          </div>
